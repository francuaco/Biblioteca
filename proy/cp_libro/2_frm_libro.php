<?php 
    ...
    include_once("2_xajax_libro.php");
    session_start();
    ...
    <body class="no-skin">
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#tabla_libros > thead > tr > th input[type=checkbox]').eq(0).on('click', function(){
                ...
                $('#tabla_libros').on('click', 'td input[type=checkbox]' , function(){
                    ...
                    $(document).on('click', '#tabla_libros .dropdown-toggle', function(e) {
