...
include_once('2_html_usuario.php');
...
//=========================================================================================
	...
	function update_situacion($usu_catalogo, $valor){
		$respuesta = new xajaxResponse();


		$cls_usuario = new cls_usuario();

		$sql = $cls_usuario->update_usuario_situacion(
			$usu_catalogo,$valor 
		);
		...
		if($rs == 1){
			...
			$respuesta->redirect('../cp_usuario/2_frm_usuario.php');
			return $respuesta;
		}else{
			$respuesta->redirect('../cp_usuario/2_frm_usuario.php');
			return $respuesta;
	...
	$xajax->register(XAJAX_FUNCTION, "update_situacion");
